...
def signupWindow():
    ...
    signup_button = Button(root, text="SIGN UP", borderwidth=0, relief=FLAT, font=("Louis George Café Bold", 15),bg='#5dbfe3',activebackground='#5dbfe3',fg='#000000', command=signupnew)
